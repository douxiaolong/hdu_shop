...
import com.dxl.mall.model.UmsMemberExample;
import com.dxl.mall.model.UmsMemberLevel;
import com.dxl.mall.model.UmsMemberLevelExample;
import com.dxl.mall.portal.domain.MemberDetails;
...
public class UmsMemberServiceImpl implements UmsMemberService {
    ...
    public UmsMember getByTelephone(String telephone) {
        ...
        if (!CollectionUtils.isEmpty(memberList)) {
            member = memberList.get(0);
            memberCacheService.setMemberByTelephone(member);
            return member;
        }
        return null;
    }
    ...
    @Override
    public String generateAuthCode(String telephone) throws Exception {
        ...
        smsService.send(telephone,sb.toString());
        return sb.toString();
    }
    ...
    public UserDetails loadUserByTelephone(String telephone) {
        UmsMember member = getByTelephone(telephone);
        if(member!=null){
            return new MemberDetails(member);
        }
    ...
    @Override
    public String loginByTelephone(String telephone, String password) {
